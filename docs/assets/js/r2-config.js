...
(function () {
  try {
    ...
    var file = (slug === "jamm-visual") ? "JAMM-visual-1.jpg" : (slug === "columbus-way") ? "columbus-way-6.jpg" : (slug === "sunnyside") ? "sunnyside-11.jpg" : (slug === "oakwood") ? "oakwood-3.jpg" : (slug === "wilshire") ? "wilshire-2.jpg" : (slug === "ronda") ? "ronda-8.jpg" : (slug === "monaco") ? "monaco-5.jpg" : (slug === "valley-vista") ? "valley-vista-5.jpg" : (slug === "brown-deer-park") ? "brown-deer-park-7.jpg" : slug + "-1.jpg";
